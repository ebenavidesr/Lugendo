...
- [x] Textos importados llegan sin artefactos de scraping — todo el texto pasa por `sanitize-html` (sin tags/entidades HTML residuales); verificado en muestra aleatoria de itinerarios
