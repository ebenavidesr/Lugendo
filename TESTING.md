...
- [ ] Agencia: paso Invitaciones y el envío real de "Crear viaje" de principio a fin (no se completó por la razón indicada arriba) — pendiente de repetir con un itinerario de prueba desechable, o que Quique lo confirme directamente
