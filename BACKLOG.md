...
| #176 | Sistema de color/badges unificado — implementado: `EstadoBadge` único en Itinerarios/Hoteles/Viajes/Equipo/Agencias/Actividades, fondos `--background`/`--card` a Arena/Duna (cambio global, afecta toda la app), chip "Playa" corregido; pendiente decisión sobre colisión de color rol Viajero/estado Activo y verificación visual en producción | 🟡 Media | General | Yo |
