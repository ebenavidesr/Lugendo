...
| #133 | Reestructurar `Dockerfile` para copiar `package.json`/lockfiles antes de `pnpm install` (aprovechar cache de capas de Docker, deploys más rápidos) — en cola, ejecutar tras resolver el problema de la key de OpenAI en Railway | 🟢 Baja | Infraestructura | Yo |
