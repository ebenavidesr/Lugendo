...
export const CreateItineraryDayBody = zod.object({
  ...
  "cityFromCountry": zod.string().optional(),
  "cityToCountry": zod.string().optional(),
  "transport": zod.union([zod.literal('plane'),zod.literal('ship'),zod.literal('ferry'),zod.literal('train'),zod.literal('self_drive'),zod.literal('car_driver'),zod.literal('bus'),zod.literal('motorcycle'),zod.literal('bicycle'),zod.literal('walking'),zod.literal(null)]).nullish(),
  "description": zod.string().optional(),
...
export const GetTripResponse = zod.object({
  ...
  "address": zod.string().nullish(),
  "description": zod.string().nullish().describe('Descripción del catálogo de actividades (#159).'),
  "durationHours": zod.number().nullish(),
  "notes": zod.string().nullish(),
...
export const AddTripDayActivityBody = zod.object({
  ...
  "activityTitle": zod.string().optional(),
